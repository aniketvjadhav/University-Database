...
$message	.=	"Quiz Date: <select name='day' id='day' class='select-input' onChange='checkdate()' >
...
$message	.=	"<tr height='20'></tr><tr><td></td><td></td><td></td><td><input class='login' type='submit' value='Update' name='GradeQuizUpdateSubmit' id='GradeQuizUpdateSubmit' /></td>";
$message	.=	"</table></td>";
