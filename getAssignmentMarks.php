...
$message	.=	"<tr height='20'></tr><tr><td></td><td></td><td></td><td><input class='login' type='submit' value='Update' name='GradeAssignmentUpdateSubmit' id='GradeAssignmentUpdateSubmit' /></td>";
$message	.=	"</table></td>";
