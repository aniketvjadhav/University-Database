...
if	( $rows2['StudentExists'] == 0 )
{
	...
	$message	=	"<div class='error'><p class='myText1'><b>$S_FirstName $S_LastName</b> has not taken<br><b>$courseId"."."."$section : $CourseName</b> <br>under <b>$P_FirstName $P_LastName</b></p></div>";
	...
	$confirmation	=	"<div class='warning'><p class='myText1'>Do you want to drop <b>$S_FirstName $S_LastName</b> <br>for <b>$courseId"."."."$section : $CourseName</b> <br>under <b>$P_FirstName $P_LastName</b></p></div>";
	
	$confirmButton	=	"<input type='submit' class='login' name='CDF_DropConfirmYes' id='CDF_DropConfirmYes' value='YES' /> <input type='submit' style='margin-left:15px' name='CDF_DropConfirmNo' id='CDF_DropConfirmNo' class='login' value='No' />";
